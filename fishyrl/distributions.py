...
class TwoHot:
    ...
    def rsample(self) -> torch.Tensor:
        ...
        # dist = torch.distributions.Categorical(logits=self._logits, total_count=2)  # TODO: Try without replacement
        # left_bin, right_bin = dist.sample().unbind(dim=-1)  # NOTE: rsample is not implemented
        # left_bin, right_bin = left_bin.unsqueeze(-1), right_bin.unsqueeze(-1)  # Unsqueeze for gathering
